...
public class DebuggingWordCount {
  ...
  public static class FilterTextFn extends DoFn<KV<String, Long>, KV<String, Long>> {
     ...
     * FilterTextFn as the logger. Depending on your SLF4J configuration, log
     * statements will likely be qualified by this name.
     *
     * <p>
     * Note that this is entirely standard SLF4J usage. Some runners may provide a
     * default SLF4J configuration that is most appropriate for their logging
     * integration.
     */
  ...
  static void runDebuggingWordCount(WordCountOptions options) {
    ...
    List<KV<String, Long>> expectedResults =
        Arrays.asList(KV.of("it", 53L), KV.of("PGM", 74L));
